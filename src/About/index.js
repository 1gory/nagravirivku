...
export default () => (
  <Wrapper>
    ...
    <TextAbout>
        ...
        <br />Для этого используем лазерную резку и гравировку, УФ-печать на различных материалах.
        <br />
        <br /> Наше оборудование позволяет выполнять:
        <br />- резку до 1290х900мм
        <br />- гравировку до 1100х850мм
        <br />- УФ-печать до 300х280мм.
        <br /> Если вам нужен больший формат- позвоните нам! Мы обязательно придумаем, как вам помочь.
        <br />  Зачастую, предприятия, занимающиеся сверхбольшими форматами, находятся далеко за городом и мы с ними поддерживаем плотные контакты, поэтому всегда сможем вас направить.
        <br />
        <br />Не было времени или возможности создать макет? Это не проблема, подготовим макет любой сложности.it
